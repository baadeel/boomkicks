...
<head>
    ...
    <link rel="stylesheet" href="/recursos/css/confirmar-compra.css">
</head>
...
<body>
    ...
    <main>
        <div id="confirmar-compra">
            ...
            <h3>Elige una dirección:</h3>
            <div id="direcciones">
                <?php
                //Pintar direcciones (si hay)
                $hayDirecciones = $direccionControlador->pintarDireccionesCarrito($_SESSION["id"]);
                ?>
            </div>
            <?php
            if ($hayDirecciones) {
                echo '<button disabled id="confirmar">Confirmar compra</button>';
            };
            ?>
...
<script src="/recursos/scripts/confirmarCompra.js"></script>
