...
<body>
    ...
    <main>
        <section id="compra-realizada">
            <h1>La compra se ha realizado con éxito. <br> <a href="/vista/cuenta/historial-compras.php">Haz click aquí para ver el Historial de compras</a></h1>
        </section>
    </main>
    <footer>
        <p>
