...
<body>
    ...
    <?php else: ?>
        <section id="formulario">
            ...
            <form id="form" action="registro_confirmado.php" method="post">
                <div class="campo">
            ...
            <p id="link-iniciar">¿Ya tienes una cuenta? <a href="iniciar_sesion.php">Inicia sesión aquí</a></p>
        </section>
    <?php endif; ?>
    </main>

</body>
<script src="../../recursos/scripts/validarFormularioRegistro.js"></script>
</html>