...
if (isset($_SESSION["usuario_logueado"]) && $_SESSION["usuario_logueado"] === true) {
    ...
    header("Location: /vista/usuario/iniciar_sesion.php");
}
?>
<!DOCTYPE html>
<html lang="es">
    ...
    <main>
        <section id="likes">
            ...
            <article class="productos">
                <?php
                //Mostrar los productos con likes (si hay)
                $listaLikes = $productoControlador->obtenerProductosLikes($_SESSION["id"]);
                if (count($listaLikes) > 0) {
                    $productoControlador->pintarListasProductos($listaLikes, $likes);
                } else {
                    echo "<h1 style='color: #000'>No tienes productos favoritos</h1>";
                }
                ?>
            </article>
        </section>
...
<script src="/recursos/scripts/likes.js"></script>
