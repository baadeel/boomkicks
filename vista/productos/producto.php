    ...
    <main>
        <section id="producto">
            ...
            if (!isset($error)) {
                ...
                $productoControlador->pintarProducto($producto, $likes);
            } else {
...
<script src="/recursos/scripts/producto.js"></script>
<script type="module" src="/recursos/scripts/usarCarrito.js"></script>
