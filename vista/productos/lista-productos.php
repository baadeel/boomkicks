...
<body>
    ...
    <main>
       <section id="filtros">
            <select id="cat-filtro">
                <?php $productoControlador->pintarCategoriasFormulario(); ?>
            </select>
            <select id="marca-filtro">
            <?php $productoControlador->pintarMarcasFormulario(false); ?>
            </select>
        </section>
        <section id="busqueda">
        ...
        <?php
                    ...
                    $lista = $productoControlador->obtenerListaTodosProductos();        
                    $productoControlador->pintarListasProductos($lista, $likes);
...
<script src="/recursos/scripts/lista-productos.js"></script>
</html>